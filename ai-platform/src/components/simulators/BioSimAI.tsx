...
const DATA_SET = [
    { id: 'T-145', name: '바이오심 AI 표준 모델', type: 'STANDARD' },
        { id: 'X-22', name: '고도화 시뮬레이션 베타', type: 'ADVANCED' },
        { id: 'E-875', name: '실시간 리전 데이터셋 연동', type: 'REALTIME' },
    ...
    return (
        <div className="sim-ui">
            <div className="panel-header">
                <h3>🧬 바이오심 AI 허브</h3>
                <p>유전자 시퀀스를 입력하면 단백질 접힘 패턴을 시각적으로 예측하고 분석합니다.</p>
            </div>
            ...
            <div className="dashboard-layout">
                ...
                <div className="side-panel glass-card">
                    ...
                    <div className="station-list">
                        <div className="list-header">가용 바이오심 AI 리소스</div>
                        {items.map(st => (
                            <button
                                key={st.id}
                ...
                <div className="detail-panel glass-card">
                    ...
                    {loading && (
                        <div className="loading-detail">
                            ...
                            <p>글로벌 클러스터의 컴퓨팅 자원을 할당받아 바이오심 AI 연산을 진행중입니다...</p>
                        </div>
                    )}
