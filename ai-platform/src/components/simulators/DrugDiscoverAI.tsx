...
const DATA_SET = [
    { id: 'T-482', name: '드럭디스커버 AI 표준 모델', type: 'STANDARD' },
        { id: 'X-304', name: '고도화 시뮬레이션 베타', type: 'ADVANCED' },
        { id: 'E-770', name: '실시간 리전 데이터셋 연동', type: 'REALTIME' },
        { id: 'O-862', name: '히스토리컬 예측 가중치', type: 'HISTORICAL' }
];
    ...
    return (
        <div className="sim-ui">
            <div className="panel-header">
                <h3>🧫 드럭디스커버 AI 허브</h3>
                <p>타겟 단백질과 후보 화합물의 결합 친화도를 예측하여 신약 후보를 탐색합니다.</p>
            </div>
            ...
            <div className="dashboard-layout">
                ...
                <div className="side-panel glass-card">
                    ...
                    <div className="station-list">
                        <div className="list-header">가용 드럭디스커버 AI 리소스</div>
                        {items.map(st => (
                            <button
                                key={st.id}
                ...
                <div className="detail-panel glass-card">
                    ...
                    {loading && (
                        <div className="loading-detail">
                            ...
                            <p>글로벌 클러스터의 컴퓨팅 자원을 할당받아 드럭디스커버 AI 연산을 진행중입니다...</p>
                        </div>
                    )}
