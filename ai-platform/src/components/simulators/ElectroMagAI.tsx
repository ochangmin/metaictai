...
const DATA_SET = [
    { id: 'T-32', name: '일렉트로맥 AI 표준 모델', type: 'STANDARD' },
        { id: 'X-495', name: '고도화 시뮬레이션 베타', type: 'ADVANCED' },
        { id: 'E-921', name: '실시간 리전 데이터셋 연동', type: 'REALTIME' },
        { id: 'O-690', name: '히스토리컬 예측 가중치', type: 'HISTORICAL' }
];
    ...
    return (
        <div className="sim-ui">
            <div className="panel-header">
                <h3>🧲 일렉트로맥 AI 허브</h3>
                <p>전하 배치와 전류에 따른 전기장/자기장 분포를 인터랙티브하게 시각화합니다.</p>
            </div>
            ...
            <div className="dashboard-layout">
                ...
                <div className="side-panel glass-card">
                    ...
                    <div className="station-list">
                        <div className="list-header">가용 일렉트로맥 AI 리소스</div>
                        {items.map(st => (
                            <button
                                key={st.id}
                ...
                <div className="detail-panel glass-card">
                    ...
                    {loading && (
                        <div className="loading-detail">
                            ...
                            <p>글로벌 클러스터의 컴퓨팅 자원을 할당받아 일렉트로맥 AI 연산을 진행중입니다...</p>
                        </div>
                    )}
