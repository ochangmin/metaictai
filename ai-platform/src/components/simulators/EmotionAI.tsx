...
const DATA_SET = [
    { id: 'T-476', name: '이모션 AI 표준 모델', type: 'STANDARD' },
        { id: 'X-611', name: '고도화 시뮬레이션 베타', type: 'ADVANCED' },
        { id: 'E-794', name: '실시간 리전 데이터셋 연동', type: 'REALTIME' },
        { id: 'O-558', name: '히스토리컬 예측 가중치', type: 'HISTORICAL' }
];
    ...
    return (
        <div className="sim-ui">
            <div className="panel-header">
                <h3>🎭 이모션 AI 허브</h3>
                <p>텍스트와 표정 데이터에서 감정 상태를 다차원으로 분석하고 시각화합니다.</p>
            </div>
            ...
            <div className="dashboard-layout">
                ...
                <div className="side-panel glass-card">
                    ...
                    <div className="station-list">
                        <div className="list-header">가용 이모션 AI 리소스</div>
                        {items.map(st => (
                            <button
                                key={st.id}
                ...
                <div className="detail-panel glass-card">
                    ...
                    {loading && (
                        <div className="loading-detail">
                            ...
                            <p>글로벌 클러스터의 컴퓨팅 자원을 할당받아 이모션 AI 연산을 진행중입니다...</p>
                        </div>
                    )}
