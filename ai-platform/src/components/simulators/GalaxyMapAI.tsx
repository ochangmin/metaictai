...
const DATA_SET = [
    { id: 'T-557', name: '갤럭시맵 AI 표준 모델', type: 'STANDARD' },
        { id: 'X-747', name: '고도화 시뮬레이션 베타', type: 'ADVANCED' },
        { id: 'E-512', name: '실시간 리전 데이터셋 연동', type: 'REALTIME' },
        { id: 'O-465', name: '히스토리컬 예측 가중치', type: 'HISTORICAL' }
];
    ...
    return (
        <div className="sim-ui">
            <div className="panel-header">
                <h3>🔭 갤럭시맵 AI 허브</h3>
                <p>천체 좌표 데이터를 분석하여 은하 분포와 별 스펙트럼을 시각화합니다.</p>
            </div>
            ...
            <div className="dashboard-layout">
                ...
                <div className="side-panel glass-card">
                    ...
                    <div className="station-list">
                        <div className="list-header">가용 갤럭시맵 AI 리소스</div>
                        {items.map(st => (
                            <button
                                key={st.id}
                ...
                <div className="detail-panel glass-card">
                    ...
                    {loading && (
                        <div className="loading-detail">
                            ...
                            <p>글로벌 클러스터의 컴퓨팅 자원을 할당받아 갤럭시맵 AI 연산을 진행중입니다...</p>
                        </div>
                    )}
