...
const DATA_SET = [
    { id: 'T-435', name: '게임씨어리 AI 표준 모델', type: 'STANDARD' },
        { id: 'X-780', name: '고도화 시뮬레이션 베타', type: 'ADVANCED' },
        { id: 'E-920', name: '실시간 리전 데이터셋 연동', type: 'REALTIME' },
        { id: 'O-581', name: '히스토리컬 예측 가중치', type: 'HISTORICAL' }
];
    ...
    return (
        <div className="sim-ui">
            <div className="panel-header">
                <h3>🎮 게임씨어리 AI 허브</h3>
                <p>죄수의 딜레마 등 전략적 의사결정 시나리오를 시뮬레이션하고 내쉬 균형을 찾습니다.</p>
            </div>
            ...
            <div className="dashboard-layout">
                ...
                <div className="side-panel glass-card">
                    ...
                    <div className="station-list">
                        <div className="list-header">가용 게임씨어리 AI 리소스</div>
                        {items.map(st => (
                            <button
                                key={st.id}
                ...
                <div className="detail-panel glass-card">
                    ...
                    {loading && (
                        <div className="loading-detail">
                            ...
                            <p>글로벌 클러스터의 컴퓨팅 자원을 할당받아 게임씨어리 AI 연산을 진행중입니다...</p>
                        </div>
                    )}
