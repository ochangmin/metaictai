...
const DATA_SET = [
    { id: 'T-67', name: '스마트온실 AI 표준 모델', type: 'STANDARD' },
        { id: 'X-454', name: '고도화 시뮬레이션 베타', type: 'ADVANCED' },
        { id: 'E-31', name: '실시간 리전 데이터셋 연동', type: 'REALTIME' },
        { id: 'O-270', name: '히스토리컬 예측 가중치', type: 'HISTORICAL' }
];
    ...
    return (
        <div className="sim-ui">
            <div className="panel-header">
                <h3>🏠 스마트온실 AI 허브</h3>
                <p>작물별·계절별 최적 온실 환경(온도, 습도, CO₂, 광량)을 자동 설정하고 에너지 비용을 관리합니다.</p>
            </div>
            ...
            <div className="dashboard-layout">
                ...
                <div className="side-panel glass-card">
                    ...
                    <div className="station-list">
                        <div className="list-header">가용 스마트온실 AI 리소스</div>
                        {items.map(st => (
                            <button
                                key={st.id}
                ...
                <div className="detail-panel glass-card">
                    ...
                    {loading && (
                        <div className="loading-detail">
                            ...
                            <p>글로벌 클러스터의 컴퓨팅 자원을 할당받아 스마트온실 AI 연산을 진행중입니다...</p>
                        </div>
                    )}
