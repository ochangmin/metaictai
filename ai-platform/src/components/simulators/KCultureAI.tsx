...
const DATA_SET = [
    { id: 'T-283', name: 'K콘텐츠 트렌드 AI 표준 모델', type: 'STANDARD' },
        { id: 'X-809', name: '고도화 시뮬레이션 베타', type: 'ADVANCED' },
        { id: 'E-503', name: '실시간 리전 데이터셋 연동', type: 'REALTIME' },
        { id: 'O-710', name: '히스토리컬 예측 가중치', type: 'HISTORICAL' }
];
    ...
    return (
        <div className="sim-ui">
            <div className="panel-header">
                <h3>🎬 K콘텐츠 트렌드 AI 허브</h3>
                <p>글로벌 소셜 미디어 트렌드와 음원/영상 데이터를 분석하여 K-콘텐츠의 타겟 국가 및 흥행을 예측합니다.</p>
            </div>
            ...
            <div className="dashboard-layout">
                ...
                <div className="side-panel glass-card">
                    ...
                    <div className="station-list">
                        <div className="list-header">가용 K콘텐츠 트렌드 AI 리소스</div>
                        {items.map(st => (
                            <button
                                key={st.id}
                ...
                <div className="detail-panel glass-card">
                    ...
                    {loading && (
                        <div className="loading-detail">
                            ...
                            <p>글로벌 클러스터의 컴퓨팅 자원을 할당받아 K콘텐츠 트렌드 AI 연산을 진행중입니다...</p>
                        </div>
                    )}
