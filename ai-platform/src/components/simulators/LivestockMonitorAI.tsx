...
const DATA_SET = [
    { id: 'T-134', name: '축산모니터 AI 표준 모델', type: 'STANDARD' },
        { id: 'X-713', name: '고도화 시뮬레이션 베타', type: 'ADVANCED' },
        { id: 'E-70', name: '실시간 리전 데이터셋 연동', type: 'REALTIME' },
        { id: 'O-223', name: '히스토리컬 예측 가중치', type: 'HISTORICAL' }
];
    ...
    return (
        <div className="sim-ui">
            <div className="panel-header">
                <h3>🐄 축산모니터 AI 허브</h3>
                <p>축종별 체중, 사료, 건강 상태를 모니터링하고 예방접종 일정을 관리합니다.</p>
            </div>
            ...
            <div className="dashboard-layout">
                ...
                <div className="side-panel glass-card">
                    ...
                    <div className="station-list">
                        <div className="list-header">가용 축산모니터 AI 리소스</div>
                        {items.map(st => (
                            <button
                                key={st.id}
                ...
                <div className="detail-panel glass-card">
                    ...
                    {loading && (
                        <div className="loading-detail">
                            ...
                            <p>글로벌 클러스터의 컴퓨팅 자원을 할당받아 축산모니터 AI 연산을 진행중입니다...</p>
                        </div>
                    )}
