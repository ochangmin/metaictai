...
const DATA_SET = [
    { id: 'T-231', name: '로지체인 AI 표준 모델', type: 'STANDARD' },
        { id: 'X-745', name: '고도화 시뮬레이션 베타', type: 'ADVANCED' },
    ...
    return (
        <div className="sim-ui">
            <div className="panel-header">
                <h3>📦 로지체인 AI 허브</h3>
                <p>물류 네트워크의 배송 경로, 재고 관리, 비용 최적화를 시뮬레이션합니다.</p>
            </div>
            ...
            <div className="dashboard-layout">
                ...
                <div className="side-panel glass-card">
                    ...
                    <div className="station-list">
                        <div className="list-header">가용 로지체인 AI 리소스</div>
                        {items.map(st => (
                            <button
                                key={st.id}
                ...
                <div className="detail-panel glass-card">
                    ...
                    {loading && (
                        <div className="loading-detail">
                            ...
                            <p>글로벌 클러스터의 컴퓨팅 자원을 할당받아 로지체인 AI 연산을 진행중입니다...</p>
                        </div>
                    )}
