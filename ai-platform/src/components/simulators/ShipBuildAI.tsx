...
const DATA_SET = [
    { id: 'T-62', name: '조선해양설계 AI 표준 모델', type: 'STANDARD' },
        { id: 'X-346', name: '고도화 시뮬레이션 베타', type: 'ADVANCED' },
        { id: 'E-82', name: '실시간 리전 데이터셋 연동', type: 'REALTIME' },
        { id: 'O-996', name: '히스토리컬 예측 가중치', type: 'HISTORICAL' }
];
    ...
    return (
        <div className="sim-ui">
            <div className="panel-header">
                <h3>🚢 조선해양설계 AI 허브</h3>
                <p>최신 선박의 유체역학적 저항을 시뮬레이션하여 연비 최적화와 친환경 탄소 저감 효과를 분석합니다.</p>
            </div>
            ...
            <div className="dashboard-layout">
                ...
                <div className="side-panel glass-card">
                    ...
                    <div className="station-list">
                        <div className="list-header">가용 조선해양설계 AI 리소스</div>
                        {items.map(st => (
                            <button
                                key={st.id}
                ...
                <div className="detail-panel glass-card">
                    ...
                    {loading && (
                        <div className="loading-detail">
                            ...
                            <p>글로벌 클러스터의 컴퓨팅 자원을 할당받아 조선해양설계 AI 연산을 진행중입니다...</p>
                        </div>
                    )}
