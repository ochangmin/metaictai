...
const DATA_SET = [
    { id: 'T-602', name: '시그널프록 AI 표준 모델', type: 'STANDARD' },
        { id: 'X-717', name: '고도화 시뮬레이션 베타', type: 'ADVANCED' },
        { id: 'E-359', name: '실시간 리전 데이터셋 연동', type: 'REALTIME' },
        { id: 'O-360', name: '히스토리컬 예측 가중치', type: 'HISTORICAL' }
];
    ...
    return (
        <div className="sim-ui">
            <div className="panel-header">
                <h3>📡 시그널프록 AI 허브</h3>
                <p>신호를 입력하면 FFT 스펙트럼, 필터링, 노이즈 제거를 실시간으로 시뮬레이션합니다.</p>
            </div>
            ...
            <div className="dashboard-layout">
                ...
                <div className="side-panel glass-card">
                    ...
                    <div className="station-list">
                        <div className="list-header">가용 시그널프록 AI 리소스</div>
                        {items.map(st => (
                            <button
                                key={st.id}
                ...
                <div className="detail-panel glass-card">
                    ...
                    {loading && (
                        <div className="loading-detail">
                            ...
                            <p>글로벌 클러스터의 컴퓨팅 자원을 할당받아 시그널프록 AI 연산을 진행중입니다...</p>
                        </div>
                    )}
