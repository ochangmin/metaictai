...
const DATA_SET = [
    { id: 'T-81', name: '스타일트랜스퍼 AI 표준 모델', type: 'STANDARD' },
        { id: 'X-923', name: '고도화 시뮬레이션 베타', type: 'ADVANCED' },
        { id: 'E-533', name: '실시간 리전 데이터셋 연동', type: 'REALTIME' },
        { id: 'O-211', name: '히스토리컬 예측 가중치', type: 'HISTORICAL' }
];
    ...
    return (
        <div className="sim-ui">
            <div className="panel-header">
                <h3>🎨 스타일트랜스퍼 AI 허브</h3>
                <p>이미지에 유명 화풍(고흐, 모네 등)을 적용하는 신경 스타일 변환을 시뮬레이션합니다.</p>
            </div>
            ...
            <div className="dashboard-layout">
                ...
                <div className="side-panel glass-card">
                    ...
                    <div className="station-list">
                        <div className="list-header">가용 스타일트랜스퍼 AI 리소스</div>
                        {items.map(st => (
                            <button
                                key={st.id}
                ...
                <div className="detail-panel glass-card">
                    ...
                    {loading && (
                        <div className="loading-detail">
                            ...
                            <p>글로벌 클러스터의 컴퓨팅 자원을 할당받아 스타일트랜스퍼 AI 연산을 진행중입니다...</p>
                        </div>
                    )}
