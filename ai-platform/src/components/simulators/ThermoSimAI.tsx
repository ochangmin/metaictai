...
const DATA_SET = [
    { id: 'T-116', name: '서모심 AI 표준 모델', type: 'STANDARD' },
        { id: 'X-670', name: '고도화 시뮬레이션 베타', type: 'ADVANCED' },
        { id: 'E-567', name: '실시간 리전 데이터셋 연동', type: 'REALTIME' },
        { id: 'O-410', name: '히스토리컬 예측 가중치', type: 'HISTORICAL' }
];
    ...
    return (
        <div className="sim-ui">
            <div className="panel-header">
                <h3>🌡️ 서모심 AI 허브</h3>
                <p>열역학 사이클(카르노, 랭킨 등)을 시뮬레이션하고 효율을 계산합니다.</p>
            </div>
            ...
            <div className="dashboard-layout">
                ...
                <div className="side-panel glass-card">
                    ...
                    <div className="station-list">
                        <div className="list-header">가용 서모심 AI 리소스</div>
                        {items.map(st => (
                            <button
                                key={st.id}
                ...
                <div className="detail-panel glass-card">
                    ...
                    {loading && (
                        <div className="loading-detail">
                            ...
                            <p>글로벌 클러스터의 컴퓨팅 자원을 할당받아 서모심 AI 연산을 진행중입니다...</p>
                        </div>
                    )}
