...
const DATA_SET = [
    { id: 'T-360', name: '어반플랜 AI 표준 모델', type: 'STANDARD' },
        { id: 'X-194', name: '고도화 시뮬레이션 베타', type: 'ADVANCED' },
        { id: 'E-629', name: '실시간 리전 데이터셋 연동', type: 'REALTIME' },
        { id: 'O-926', name: '히스토리컬 예측 가중치', type: 'HISTORICAL' }
];
    ...
    return (
        <div className="sim-ui">
            <div className="panel-header">
                <h3>🏙️ 어반플랜 AI 허브</h3>
                <p>도시 구역별 인구, 교통, 녹지 데이터를 종합하여 최적 도시 설계를 제안합니다.</p>
            </div>
            ...
            <div className="dashboard-layout">
                ...
                <div className="side-panel glass-card">
                    ...
                    <div className="station-list">
                        <div className="list-header">가용 어반플랜 AI 리소스</div>
                        {items.map(st => (
                            <button
                                key={st.id}
                ...
                <div className="detail-panel glass-card">
                    ...
                    {loading && (
                        <div className="loading-detail">
                            ...
                            <p>글로벌 클러스터의 컴퓨팅 자원을 할당받아 어반플랜 AI 연산을 진행중입니다...</p>
                        </div>
                    )}
